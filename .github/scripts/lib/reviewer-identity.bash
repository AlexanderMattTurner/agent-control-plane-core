...
#
# Deliberately sources NOTHING. The workflow jobs fetch the gate script through a
# narrow `sparse-checkout` list and this file rides along in each; a `source` here
# would need its own target added to those lists too.
#
# Consumers: lib/pr-reviews.bash, lib/review-threads.bash, and through them
